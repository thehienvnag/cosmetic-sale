<%@ Page Title="Manage Products" Language="C#" MasterPageFile="~/CosmeticSale.Master" AutoEventWireup="true" CodeBehind="ManageProducts.aspx.cs" Inherits="CSharpAssignment.ManageProducts" %>
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                    ...
                    <div class="row">
                        ...
                        <div class="col-6">
                            <div class="form-group">
                                ...
                                <asp:Button CssClass="btn btn-info" ID="BtnPreview" runat="server" OnClick="BtnPreview_Click" Text="Preview" />
                ...
                <div class="modal-footer">
                    ...
                    <asp:Button class="btn btn-primary" ID="BtnUpdate" runat="server" Text="Update" OnClick="BtnUpdate_Click" OnClientClick="return confirm('Are you sure?')" />
                    <asp:Button class="btn btn-primary" ID="BtnInsert" runat="server" Text="Insert" OnClick="BtnInsert_Click" OnClientClick="return confirm('Are you sure?')" />
                    <asp:Button CssClass="btn btn-danger" ID="BtnDelete" runat="server" Text="Delete" OnClick="BtnDelete_Click" OnClientClick="return confirm('Are you sure?')" />
